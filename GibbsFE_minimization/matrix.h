...
public:
    ...
    const T      operator*(const Vector1d<T>&);    // dot product

    Vector1d<T>  operator+(const Vector1d<T>&);
    Vector1d<T>  operator-(const Vector1d<T>&);
    Vector1d<T>  operator+(const T&);
    Vector1d<T>  operator-(const T&);
    Vector1d<T>  operator*(const T&);
    Vector1d<T>  operator/(const T&);
...
public:
    ...
    void resize(const T& a, int nn, int mm);
    Vector1d<T> rowvector(const int j);
    Vector1d<T> colvector(const int i);
